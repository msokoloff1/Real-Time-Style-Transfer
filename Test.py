...
class LoadedModel():
    ...
    def predict(self, testPath,pathIsDir,destDir, prefix):
        if(pathIsDir):
            for element in os.listdir(testPath):
                ...
                utils.showImage(img,self.imageShape, destDir, prefix + str(element))
    ...
    def predictImage(self, imgData):
        ...
        return img.reshape(self.imageShape[0], self.imageShape[1], self.imageShape[2])
